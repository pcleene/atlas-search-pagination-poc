...
2. Create a new database called `aerotrade`
3. Create a collection called `parts`
...
mongoimport --uri "mongodb+srv://<user>:<password>@<cluster>.mongodb.net/<db>" \
  --collection parts \
...
# - Navigate to aerotrade.parts
# - Click "Add Data" > "Import File"
# - Select mongodb_import.json
```
